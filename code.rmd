...
So sánh các chỉ số mô hình của các lần thử nghiệm, các thông số Macro-F1 và Kappa đều gần xấp xỉ nhau. Tuy nhiên, Vì dữ liệu bị mất cân bằng nghiêm trọng, sử dụng các phương pháp khác sẽ làm dữ liệu bị mất tính đa dạng hay bị lặp, nên nhóm quyết định sẽ chọn ra Combine Data, tức là dữ liệu được xử lý mất cân bằng bằng cách kết hợp Undersampling cho nhãn nhiều dữ liệu nhất về trung bình và SMOTE cho hai nhãn còn lại, huấn luyện trên các mô hình khác để tiếp tục kết quả tốt nhất.  
